...
exports.handleAgentCreated = handleAgentCreated;
exports.handleAgentStarted = handleAgentStarted;
exports.handleAgentStopped = handleAgentStopped;
exports.handleSignalGenerated = handleSignalGenerated;
const utils_1 = require("./utils");
// Create a logger instance
const logger = (0, utils_1.createLogger)('AgentEventHandlers');
// Event handlers
async function handleAgentCreated(event) {
...
async function handleAgentStarted(event) {
...
async function handleAgentStopped(event) {
    const { agentId } = event.payload;
...
async function handleSignalGenerated(event) {
...
async function evaluateSignalForAgent(agentId, signal) {
