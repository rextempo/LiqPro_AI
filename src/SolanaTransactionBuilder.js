...
class SolanaTransactionBuilder {
     ...
     */
    async buildAddLiquidityTransaction(poolAddress, amount, binRange) {
     ...
     * @param binRange 可选的bin范围
     */
    async buildRemoveLiquidityTransaction(poolAddress, amount, binRange) {
     ...
     */
    async buildSwapTransaction(fromToken, toToken, amount, slippage = 0.005 // 默认0.5%滑点
    ) {
     ...
     */
    async buildEmergencyExitTransaction(poolAddresses) {
...
//# sourceMappingURL=SolanaTransactionBuilder.js.map