...
export class AlertController {
  ...
  async getAlertById(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error fetching alert by ID', { error, id: req.params.id });
  ...
  async updateAlert(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('Updating alert', { id, updateData });
      ...
      logger.error('Error updating alert', { error, id: req.params.id });
  ...
  async deleteAlert(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error deleting alert', { error, id: req.params.id });
  ...
  async dismissAlert(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error dismissing alert', { error, id: req.params.id });
      throw new ApiError(500, 'Failed to dismiss alert');
    }
  }
  ...
  async getAlertSettings(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('Fetching alert settings', { type });
      ...
      throw new ApiError(500, 'Failed to fetch alert settings');
    }
  }
  ...
  async updateAlertSettings(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('Updating alert settings', { settingsData });
