import { DataController, PoolData, WhaleActivity, TimePeriod } from '../../src/controllers/data-controller';
...
describe('DataController', () => {
  ...
  describe('Subscription methods', () => {
    ...
    test('should subscribe to pool updates', () => {
      ...
      expect(dataController['poolSubscriptions'].get(mockPoolAddress)?.has(mockCallback)).toBe(true);
    });
