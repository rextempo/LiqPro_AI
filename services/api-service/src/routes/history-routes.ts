 ...
 */
router.get('/signals', 
  validate(schemas.history.getSignals, 'query'),
  asyncHandler(historyController.getSignalHistory)
);
 ...
 *         description: Server error
 */
router.get('/performance/:poolAddress', 
  validate(schemas.history.getPerformance, 'params'),
  asyncHandler(historyController.getPoolPerformance)
);
 ...
 */
router.get('/accuracy', 
  validate(schemas.history.getAccuracy, 'query'),
  asyncHandler(historyController.getAccuracyMetrics)
);
 ...
 */
router.get('/trends', 
  validate(schemas.history.getTrends, 'query'),
  asyncHandler(historyController.getTrendAnalysis)
);
 ...
 */
router.post('/export', 
  validate(schemas.history.export),
  asyncHandler(historyController.exportData)
);
