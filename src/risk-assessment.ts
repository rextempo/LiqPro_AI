...
export class RiskAssessment {
   ...
   */
  private static calculatePriceRiskScore(volatility: number, recentChange: number): number {
   ...
   */
  private static calculateLiquidityRiskScore(tvlChangePercent: number, depth: number): number {
   ...
   */
  private static calculateTradingRiskScore(volumeChangePercent: number, slippageEstimate: number): number {
   ...
   */
  private static calculateWhaleRiskScore(largeHoldersPercent: number, recentWithdrawals: number): number {
   ...
   */
  private static calculateImbalanceRiskScore(tokenRatioImbalance: number): number {
