...
export function createApiRoutes(dataController: DataController): Router {
  ...
  router.post('/pools/track', asyncHandler(async (req: Request, res: Response) => {
    ...
    Validator.validateBodyOrThrow(req.body, {
      ...
      description: (value) => value ? Validator.isString(value, 'description') : { isValid: true }
    });
  ...
  router.delete('/pools/untrack/:poolAddress', asyncHandler(async (req: Request, res: Response) => {
  ...
  router.get('/pools', asyncHandler(async (req: Request, res: Response) => {
    try {
  ...
  router.get('/data/aggregated/:poolAddress', asyncHandler(async (req: Request, res: Response) => {
    const { poolAddress } = req.params;
  ...
  router.get('/data/raw/:poolAddress', asyncHandler(async (req: Request, res: Response) => {
    const { poolAddress } = req.params;
  ...
  router.get('/data/latest/:poolAddress', asyncHandler(async (req: Request, res: Response) => {
    const { poolAddress } = req.params;
  ...
  router.get('/whales/activities', asyncHandler(async (req: Request, res: Response) => {
  ...
  router.get('/storage/stats', asyncHandler(async (req: Request, res: Response) => {
    try {
