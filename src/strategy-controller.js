...
class StrategyController {
    ...
    async getAllStrategies(req, res) {
        try {
            ...
            logger_1.logger.info('Fetching strategies', {
            ...
            throw new error_handler_1.ApiError(500, 'Failed to fetch strategies');
        }
    }
    /**
    ...
    async getStrategyById(req, res) {
        try {
            ...
            logger_1.logger.error('Error fetching strategy by ID', { error, id: req.params.id });
            throw new error_handler_1.ApiError(500, 'Failed to fetch strategy');
        }
    }
    /**
    ...
    async createStrategy(req, res) {
        try {
            ...
            throw new error_handler_1.ApiError(500, 'Failed to create strategy');
        }
    }
    /**
    ...
    async updateStrategy(req, res) {
        try {
            ...
            logger_1.logger.info('Updating strategy', { id, updateData });
            ...
            logger_1.logger.error('Error updating strategy', { error, id: req.params.id });
            throw new error_handler_1.ApiError(500, 'Failed to update strategy');
        }
    }
    /**
     * Delete a strategy
    ...
    async deleteStrategy(req, res) {
        try {
            ...
            logger_1.logger.error('Error deleting strategy', { error, id: req.params.id });
            throw new error_handler_1.ApiError(500, 'Failed to delete strategy');
        }
    }
    /**
     * Evaluate a strategy's performance
     */
    async evaluateStrategy(req, res) {
        try {
            const { id } = req.params;
            const { timeframe } = req.body;
            logger_1.logger.info('Evaluating strategy performance', { id, timeframe });
            ...
            logger_1.logger.error('Error evaluating strategy', { error, id: req.params.id });
            throw new error_handler_1.ApiError(500, 'Failed to evaluate strategy');
        }
    }
    /**
    ...
    async optimizeStrategy(req, res) {
        try {
            ...
            logger_1.logger.info('Optimizing strategy', { id, targetMetric, constraints });
            ...
            logger_1.logger.error('Error optimizing strategy', { error, id: req.params.id });
            throw new error_handler_1.ApiError(500, 'Failed to optimize strategy');
        }
    }
}
