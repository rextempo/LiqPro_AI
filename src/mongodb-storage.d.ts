 ...
 */
export declare class MongoDBStorage implements DataStorage {
    private client;
    private db;
    private collections;
    private config;
     ...
     */
    storePoolMetadata(poolAddress: string, metadata: {
        name?: string;
        description?: string;
    }): Promise<void>;
    /**
     ...
     */
    storeTokenPrices(priceData: Record<string, {
        price: number;
        source: string;
     ...
     */
    storeTokenMetadata(tokenMint: string, metadata: {
        symbol?: string;
        name?: string;
    }): Promise<void>;
    /**
     ...
     */
    getLatestTokenPrice(tokenMint: string): Promise<{
        price: number;
        source: string;
        timestamp: number;
    } | null>;
