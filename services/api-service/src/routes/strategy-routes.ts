 ...
 */
router.get('/', 
  validate(schemas.strategy.getAll, 'query'),
  asyncHandler(strategyController.getAllStrategies)
);
 ...
 */
router.get('/:id', 
  validate(schemas.strategy.getById, 'params'),
 ...
 */
router.post('/', 
  validate(schemas.strategy.create),
...
router.post('/:id/evaluate', 
  validate(schemas.strategy.getById, 'params'),
  validate(schemas.strategy.evaluate),
  asyncHandler(strategyController.evaluateStrategy)
);
...
router.post('/:id/optimize', 
  validate(schemas.strategy.getById, 'params'),
  validate(schemas.strategy.optimize),
  asyncHandler(strategyController.optimizeStrategy)
);

logger.info('Strategy routes registered');
